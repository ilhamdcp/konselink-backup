...
import id.ac.ui.cs.mobileprogramming.ilham_darmawan.konselink_client.databinding.ActivityEditProfileBinding
...
class EditProfileActivity: AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == GALLERY_REQUEST && data != null && data.data != null) {
            ...
            imageUri = FileProvider.getUriForFile(
                this,
                "id.ac.ui.cs.mobileprogramming.ilham_darmawan.konselink_client.fileprovider",
                createImageFile()
            )
    ...
    private fun assignElements() {
        ...
        val nicknameEditText = findViewById<EditText>(R.id.form_edit_nickname)
        ...
        saveProfileButton.setOnClickListener {
            if (profileViewModel.profileIsValid()) {
                profileViewModel.updateProfile(sharedPref.getString(TOKEN, "")!!, currentPhotoPath)
            } else {
                Toast.makeText(this, "Data tidak valid, mohon periksa kembali", Toast.LENGTH_SHORT).show()
            }
        }
    }
}